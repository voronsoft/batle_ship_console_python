...
class Ship:
    ...
    def move(self, go):  # TODO Метод не реализован
        """
        ...
        """
        if go == 1 and self.tp == 1:  # если корабль горизонтальный передвигаем корабль в право
            ...

        elif go == -1 and self.tp == 1:  # если корабль горизонтальный передвигаем корабль в лево
            ...

        elif go == 1 and self.tp == 2:  # если корабль вертикальный передвигаем корабль вверх
            ...

        elif go == 1 and self.tp == 2:  # если корабль вертикальный передвигаем корабль вниз
            ...
...
class GamePole:
    ...
    def move_ships(self):  # TODO: Метод не реализован
        """
...
class SeaBattle:
    ...
    def __init__(self):
        ...
        self.initiative_move_comp = None
    ...
    def checking_if_all_ships_are_hit(self):
        ...
        ship_comp = [__ for _ in play.COMP.ships for __ in _.cells]
        ship_player = [__ for _ in play.PLAYER.ships for __ in _.cells]
